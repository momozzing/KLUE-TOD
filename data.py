...
data_module = WosDataModule(tokenizer)
data_dir = 'data/wos-v1.1'
test_filename = 'wos-v1.1_dev.json'
...
ontology_filepath = os.path.join(data_dir, ontology_filename)
...
data_loader = data_module.get_dataloader(
        test_filepath, ontology_filepath, 1, shuffle=False
    )
