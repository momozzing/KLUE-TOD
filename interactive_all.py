...
ckpt_name = "model_save/skt-kogpt2-base-v2_split-11-final/pytorch_model.bin"
...
with torch.no_grad():
    while True:
        ...
        gen = sample_output[0]
        gen_text = []
        # eosb_tok = torch.LongTensor(tokenizer.encode('<eos_b>')).cuda()
        ...
        print("System :", system_utterence.replace("<eos_r>", ""))
        
        pre_turn = pre_turn + current_turn + system_utterence
